package com.rahansazeh.apiserver.logging;
...
public class RequestResponseDumpFilter implements Filter {
    private static final Logger logger = Logger.getLogger(RequestResponseDumpFilter.class);
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        try {
            ...
            final StringBuilder logMessage = new StringBuilder("REST Request - ")
                    ...
                    .append("] [URL:")
                    .append(httpServletRequest.getRequestURL().toString())
                    .append("] [PATH INFO:")
